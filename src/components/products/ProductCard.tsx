      ...
      >
        <div className="relative overflow-hidden">
          ...
          {product.originalPrice && (
            <div className="absolute top-3 left-3 px-2.5 py-1 rounded-full bg-destructive text-destructive-foreground text-xs font-semibold">Sale</div>
          )}
          {product.badge && !product.originalPrice && (
            <div className="absolute top-3 left-3 px-2.5 py-1 rounded-full bg-primary text-primary-foreground text-xs font-semibold">{product.badge}</div>
          )}
          {!product.inStock && (
        ...
        <div className="p-4">
          ...
          <div className="flex items-center gap-1 mb-3">
            ...
            <span className="text-muted-foreground text-sm">• {product.seller}</span>
          </div>
          ...
          <Button className="w-full rounded-xl bg-primary hover:bg-primary/90" disabled={!product.inStock}>
